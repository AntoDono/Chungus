...
class ModelAdmin(admin.ModelAdmin):
    list_display = ['name', 'model_type', 'provider', 'model_path', 'is_active', 'is_default', 'alwayswarm', 'total_requests', 'total_responses', 'total_errors', 'total_tokens_processed', 'created_at']
    list_filter = ['is_active', 'alwayswarm', 'provider', 'model_type', 'created_at']
    ...
    fieldsets = (
        ('Basic Information', {
            'fields': ('name', 'description', 'model_path', 'model_type', 'provider', 'is_active', 'is_default', 'alwayswarm', 'thinking_mode')
        }),
